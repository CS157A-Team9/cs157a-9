# Generated by Django 2.2.5 on 2019-11-06 01:14
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('department', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.PROTECT, to='collegeWebPortal.Department')),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.AddField(
            model_name='course',
            name='prerequisites',
            field=models.ManyToManyField(blank=True, to='collegeWebPortal.Course'),
        ),
        migrations.CreateModel(
            name='Enrollment',
            fields=[
